...
public class BookstoreApplication {
    ...
    public CommandLineRunner bookdata(BookRepository bookrepository, CategoryRepository categoryrepository) {
        return (args) -> {
            ...
            bookrepository.save(new Book("A Farewell to Arms", "Ernest Hemingway", 1929, "1232323-21", "20.60 €",
                    categoryrepository.findByName("Scifi").get(1)));
            bookrepository.save(new Book("Animal Farm", "George Orwell", 1945, "2212345-5", "14.95 €",
